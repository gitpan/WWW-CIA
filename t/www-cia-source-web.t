...
#1
BEGIN { use_ok('WWW::CIA::Source::Web'); }
...
#3
ok( $source->isa('WWW::CIA::Source::Web'), 'new() - returns a WWW::CIA::Source::Web object' );

#4
ok( ref $source->ua eq 'LWP::UserAgent', 'ua() - returns LWP::UserAgent object' );

#5
ok( ref $source->parser eq 'WWW::CIA::Parser', 'parser() - returns WWW::CIA::Parser object' );
