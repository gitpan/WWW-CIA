...
@WWW::CIA::Source::Web::ISA = ("WWW::CIA::Source");
...
sub new {
    ...
    $self->{CACHED} = "";
    $self->{CACHE} = {};
    $self->{PARSER} = WWW::CIA::Parser->new;
...
WWW::CIA::Source::Web is an interface to the live, online version of the CIA
World Factbook.
...
In order to make some small improvement in efficiency, WWW::CIA::Source::Web
