...
WWW::CIA::Parser - Parse pages from the CIA World Factbook


=head1 SYNOPSIS

  use WWW::CIA::Parser;
  my $parser = WWW::CIA::Parser->new;
  my $data = $parser->parse($string);


=head1 DESCRIPTION

WWW::CIA::Parser takes a string of HTML and parses it. It will only give
...
Creates a new WWW::CIA::Parser object. It takes no arguments.
